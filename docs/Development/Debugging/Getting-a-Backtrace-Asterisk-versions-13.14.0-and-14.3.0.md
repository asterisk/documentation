...
{numberedheadings}{numberedheadings}Overview
--------
...
In the Compiler Flags menu of menuselect and you should enable **DEBUG\_THREADS**, **DONT\_OPTIMIZE** and **BETTER\_BACKTRACES**. Then, you need to recompile, re-install, and restart Asterisk before following the steps below.
...
# asterisk -rx "core show locks" > /tmp/core-show-locks.txtFor more info on: 
...
#2 0x0813c6c7 in ast\_reentrancy\_lock (lt=0x6b736972) at /usr/local/src/asterisk-11.14/asterisk-11.14.0-rc1/include/asterisk/lock.h:420
 res = 135518668If unsure, simply add the compiler flag in menuselect and recompile then reinstall Asterisk.
...
If you think there is a memory corruption issue then you'll want to run [valgrind](https://wiki.asterisk.org/wiki/display/AST/Valgrind) to investigate further.
