...
| Threading | [utils.h](http://doxygen.asterisk.org/trunk/d5/d60/utils_8h.html)[lock.h](http://doxygen.asterisk.org/trunk/search.php?query=lock.h) | Create, manipulate, and synchronize threads. Note that these wrap the basic POSIX calls, which should never be called directly. |
...
* Are the hash and comparison callbacks for an `ao2_container` implemented correctly?
