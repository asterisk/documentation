...
2. Install "gh" from your distribution's package manager or download directly from [https://cli.github.com](https://cli.github.com/)
3. Run `gh auth login`
...
Commit messages should follow the guidelines established in .  That page will be updated as follows after the cut-over.
...
Sample Commit Messagetextapp\_something:  Add some new capability 
 
...
 
UserNote: app\_something has been updated to include new feature "X".Test and check for Cherry-pick-ability
--------------------------------------
