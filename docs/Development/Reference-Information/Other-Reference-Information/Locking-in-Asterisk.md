...
associated with an ast\_channel. Typically, both the ast\_channel and PVT have their own lock. There are *many* code paths that require both objects to be locked.
