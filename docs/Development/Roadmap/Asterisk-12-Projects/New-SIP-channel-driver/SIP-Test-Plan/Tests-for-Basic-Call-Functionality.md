...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | bind=127.0.0.1:5060protocol=udp | none | none | none | SDP in INVITE | Identify by username, no auth | Yes |
| 2 | bind=127.0.0.1:5060protocol=udp | auth = alice-auth | password = swordfish | none | SDP in INVITE | Identify by username, userpass auth | Yes |
| 3 | bind=127.0.0.1:5060protocol=udp | auth = alice-auth | auth\_type=md5md5\_cred=c9b9e23e2160fd69b19f99116da19711 | none | SDP in INVITE | Identify by username, md5 auth | Yes |
