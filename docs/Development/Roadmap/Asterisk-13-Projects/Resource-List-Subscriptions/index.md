...
Since the changes are large and deal with behind-the-scenes content, the have been relegated to their own sub-page.
...
Configuration of RLS is defined on this page.

Write test cases (nominal and off-nominal)
------------------------------------------

If a configuration scheme has been decided, testsuite tests can be written for RLS. A test plan for RLS can be found here.
