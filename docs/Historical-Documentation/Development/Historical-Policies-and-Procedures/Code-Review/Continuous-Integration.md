...
/// note
The Zuul server actually lives on <https://gerrit.asterisk.org>, due
to some quirks with its underlying SSH library and to ensure that it
has the best connection possible back to the Gerrit instance.
///
