...
[featuremap]
blindxfer = #1
atxfer = \*2Now that you have the feature enabled you need to configure the dialplan such that a particular channel will be allowed to use the feature.
...
exten = 102,1,Dial(PJSIP/BOB,30,T)Asterisk should be restarted or relevant modules should be reloaded for changes to take effect.
...
atxfercomplete = \*4
atxferthreeway = \*5
atxferswap = \*6Configuring attended transfer callbacks
---------------------------------------
...
atxferdropcall = no 
atxferloopdelay = 10 
atxfercallbackretries = 2Behavior Options
================
...
; (default is 3 seconds)### Attended transfer options
