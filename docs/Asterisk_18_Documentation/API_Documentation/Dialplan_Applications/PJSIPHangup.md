...
As with the 'Hangup' application, the dialplan will terminate after calling this function.<br>
...
```
``` title="Example: Terminate call with 437 response code based on condition"
