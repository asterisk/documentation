...
* `PreDialGoSub` - PreDialGoSub Context,Extension,Priority to set options/headers needed before start the outgoing extension<br>

### See Also

* [AMI Events OriginateResponse](/Asterisk_18_Documentation/API_Documentation/AMI_Events/OriginateResponse)
