...
| [match_request_uri](#match_request_uri)| String| | false| Request URI to match against.| |
...
The SIP request URI is used to match against.<br>

The specified SIP request URI can be a regular expression if the value is of the form / _regex_/.<br>
