...
| [internal_sample_rate](#internal_sample_rate)| Custom| auto| false| Set the internal native sample rate for mixing the conference| |
...
| [maximum_sample_rate](#maximum_sample_rate)| Custom| none| false| Set the maximum native sample rate for mixing the conference| |
