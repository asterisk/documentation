...
* [About the Project](https://wiki.asterisk.org/wiki/display/AST/About+the+Project) - Any general information about the project. Licensing, History, What is Asterisk?
* [Getting Started](https://wiki.asterisk.org/wiki/display/AST/Getting+Started) - Information relevant to completely new users, information on installation and how to get rolling into configuration and the rest of the documentation.
* [Operation](https://wiki.asterisk.org/wiki/display/AST/Operation) - Details concerning Asterisk's operation. That is, starting and stopping the Asterisk daemon, command line operation and other non-configuration tasks.
* [Fundamentals](https://wiki.asterisk.org/wiki/display/AST/Fundamentals) - Basic, key and core concepts of Asterisk. Some of the most important foundational things to know about Asterisk.
* [Configuration](https://wiki.asterisk.org/wiki/display/AST/Configuration) - How everything is configured. Where are the files? How do I use them? How do I program dialplan? How do I use the APIs?
* [Deployment](https://wiki.asterisk.org/wiki/display/AST/Deployment) - Examples, tutorials, how-tos and recommendations for specific use-cases or scenarios of deployment. How do I deal with Asterisk in a NATed environment? How do I build a simple PBX?
* [Development](https://wiki.asterisk.org/wiki/display/AST/Development) - All information regarding the development of Asterisk itself.
* [Asterisk Test Suite Documentation](https://wiki.asterisk.org/wiki/display/AST/Asterisk+Test+Suite+Documentation) - Documentation for the test suite! Primarily for developers.
* [Asterisk Security Vulnerabilities](https://wiki.asterisk.org/wiki/display/AST/Asterisk+Security+Vulnerabilities) - How the project handles security vulnerabilities.
* [Asterisk Community](https://wiki.asterisk.org/wiki/display/AST/Asterisk+Community) - Anything falling under community. The places we meet, our code of conduct, community services.
