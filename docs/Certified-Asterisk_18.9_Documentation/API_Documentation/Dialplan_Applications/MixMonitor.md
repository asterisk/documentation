...
* `options`
    ...
    * `D` - Interleave the audio coming from the channel and the audio coming to the channel in the output audio as a dual channel stream, rather than mix it.<br>
...
* [Dialplan Applications StopMixMonitor](/Certified-Asterisk_18.9_Documentation/API_Documentation/Dialplan_Applications/StopMixMonitor)
* [Dialplan Applications PauseMonitor](/Certified-Asterisk_18.9_Documentation/API_Documentation/Dialplan_Applications/PauseMonitor)
* [Dialplan Applications UnpauseMonitor](/Certified-Asterisk_18.9_Documentation/API_Documentation/Dialplan_Applications/UnpauseMonitor)
